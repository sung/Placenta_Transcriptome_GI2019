...
author_textsize: "45pt"       # Author list font size
#---POSTER BODY OPTIONS---#
...
5. featureCount and DESeq2

```{r fig1-sample, out.width="95%", fig.align='center', fig.cap="Number of placental biopsies and sequencing reads"}
...
```{r fig2-complexity, out.width="90%", fig.align='center', fig.cap='Complexity of RNA transcripts in the placenta'}
knitr::include_graphics('Figures/complexity.jpg')
```

## 2. Genes expressed specifically in the placenta
```{r placenta-specific, out.width="90%", fig.align='center', fig.cap='Abundance level of genes expressed specifically in the placenta (a: protein-coding, b: lincRNA)'}
...
```{r fig5-smallRNA, fig.height=5.3, fig.align='center', fig.cap='Size distribution of placental small RNAs. (‘Mapped reads’: mapped at least 10x, ‘-miRNA’: ‘Mapped reads’ minus miRNA, ‘-miRNA-piRNA-exon’: ‘Mapped reads’ minus miRNA, piRNAs and exon)'}
